...
fn main() {
    ...
    let char_map: [Vec<char>; 8] = [Vec::new(), Vec::new(), Vec::new(), Vec::new(), 
                                    Vec::new(), Vec::new(), Vec::new(), Vec::new()];
    let message: Vec<char> = Vec::new();
